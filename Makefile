...
COMMANDSSRC = src/commands/echo.c src/commands/export.c src/commands/cd.c src/commands/pwd.c src/commands/exit.c src/commands/env.c src/commands/unset.c utils/tab/tab.c
