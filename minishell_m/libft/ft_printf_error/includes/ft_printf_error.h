...
/*   Updated: 2026/01/24 19:57:43 by bbouarab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_int_err(int **counter, va_list copy,
			const char *conversion, int *i);
int		check_str_or_char_err(int **c, va_list copy, const char *conv, int *i);
int		check_ptr_err(int **counter, va_list copy,
			const char *conversion, int *i);
int		check_hexa_err(int **counter, va_list copy,
			const char *conversion, int *i);
